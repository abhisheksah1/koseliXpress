...
export interface CustomPageSection {
  id: string;
  type: 'banner' | 'text' | 'button' | 'image_content' | 'video' | 'slider' | 'categories_grid' | 'products_grid' | 'faq' | 'reviews' | 'google_review' | 'code_embed' | 'delivery_countdown' | 'footer_builder';
  data: {
    title?: string;
    subtitle?: string;
    content?: string;
