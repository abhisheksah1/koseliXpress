...
export default function SupportHub({ state, onUpdateState, onAddToCart, onOpenCart }: SupportHubProps) {
  ...
  const primaryColor = state.appearance?.primaryColor || '#d11252';
  const secondaryColor = state.appearance?.secondaryColor || '#492583';
      ...
      <div className="flex flex-col gap-2.5 select-none pointer-events-auto">
        ...
        <div className="relative group flex items-center justify-end">
          ...
          <button
            ...
            style={{ 
              backgroundImage: `linear-gradient(to tr, ${primaryColor || '#d11252'}, ${secondaryColor || '#f59e0b'})`,
          ...
          >
            ...
            {activePanel !== 'ai' && (
              <span className="absolute -top-1 -right-1 px-1.5 py-0.5 bg-amber-450 text-slate-950 font-black rounded-lg text-[7px] shadow uppercase tracking-wider scale-95 select-none" style={{ backgroundColor: primaryColor === '#f59e0b' ? '#d11252' : '#f59e0b', color: '#fff' }}>
                AI 24/7
              </span>
            )}
          </button>
