                    ...
                    >
                      ...
                      >
                        ...
                        <div className="min-w-0 leading-tight">
                          <h4 className="font-bold truncate text-[11.5px] hover:text-[#d11252] transition">{rec.name}</h4>
                      ...
                      <button
                        ...
                        className="p-1.5 px-3 bg-[#d11252] hover:bg-[#b00f42] text-white text-[9.5px] uppercase font-black tracking-widest rounded-lg transition-all transform active:scale-95 cursor-pointer border-0 shadow-3xs"
                      >
                        + Basket
                      </button>
                    </div>
