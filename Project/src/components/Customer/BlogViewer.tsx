...
export default function BlogViewer({ currentSlug, state, onNavigateToSlug, primaryColor = '#d11252' }: BlogViewerProps) {
  const blogs = useMemo(() => {
          ...
          <div className="space-y-4 text-left pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedBlogs.map(item => (
                ...
                >
                  <span className="text-[9px] font-mono text-purple-400 block font-bold">{item.createdAt}</span>
