              ...
              <div className="space-y-4 bg-white p-5 border border-slate-100 rounded-xl">
                            ...
                            <div className="p-4 mt-2 bg-white rounded-lg border border-slate-150 grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          ...
                                          const currentList = sections[idx].data.reviewsList || [
                                            ...
                                            { id: 'rev-3', author: 'Samikshya Thapa', rating: 4, comment: 'Very helpful builders. Loved the custom options. Slight courier delay.', relativeDate: '2 weeks ago', initials: 'ST', avatarBg: 'bg-[#492583]', timestamp: Date.now() - 1209600000 }
                                          ];
                                    ...
                                    <div className="space-y-3 max-h-[350px] overflow-y-auto pr-1">
                                      {(() => {
                                        const currentReviews = sec.data.reviewsList || [
                                          ...
                                          { id: 'rev-3', author: 'Samikshya Thapa', rating: 4, comment: 'Very helpful builders. Loved the custom options. Slight courier delay but the presentation made up for it completely. Highly satisfied!', relativeDate: '2 weeks ago', initials: 'ST', avatarBg: 'bg-[#492583]', timestamp: 1716348000 },
                              ...
                              <div className="md:col-span-2 pt-2 text-right">
                                <button
                                  ...
                                  className="px-3.5 py-1.5 bg-[#492583] hover:bg-[#341a5e] text-white rounded-lg font-bold text-xs shadow-md hover:shadow transition"
                                >
                                  Close Sub-Editor ✓
                                </button>
                              </div>
                ...
                <div className="border-t border-slate-100 pt-5 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-[9px] text-[#d11252] font-black uppercase tracking-widest bg-rose-50 px-2 py-0.5 rounded-full">100% SEO Ready</span>
                  </div>
                        ...
                        return (
                          <React.Fragment key={type}>
                            <button
                              ...
                              className="py-2.5 px-2 bg-rose-50/20 border border-rose-200/50 hover:bg-rose-50 hover:border-rose-300 rounded-lg text-left text-[#d11252] font-bold transition flex flex-col gap-0.5"
                            >
          ...
          <div className="bg-white border rounded-2xl w-full max-w-xl shadow-2xl p-6 relative max-h-[90vh] overflow-y-auto space-y-4">
            ...
            <div className="space-y-3.5 text-xs">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. anniversary-hampers"
                    className="w-full p-2 border rounded-md bg-slate-50 font-mono text-[#d11252] font-bold"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-4 p-1 bg-slate-50 rounded border max-w-xs">
                  ...
                  <button
                    ...
                    className={`flex-1 text-center py-1 rounded text-[11px] font-bold transition ${newPageStatus === 'draft' ? 'bg-[#492583] text-white shadow-xs' : 'text-slate-500'}`}
                  >
                    Draft
                  </button>
                </div>
              ...
              <div className="border-t pt-2.5">
                <span className="text-[10px] font-bold text-[#492583] uppercase tracking-wider block mb-2 font-mono">Search Engine Optimization (SEO) Metadata</span>
