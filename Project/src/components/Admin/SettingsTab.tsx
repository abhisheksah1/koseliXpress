...
import { Save, Globe, Shield, CreditCard, Sparkles, UserCheck, Trash2, Sliders, MapPin, Settings, Server, Key, Landmark, CheckSquare, Square, Upload, FileText, Eye, EyeOff, RefreshCw, Building, Clock, ArrowUp, ArrowDown, Mail, Send, History } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-1 bg-slate-100 p-1 rounded-lg text-xs font-semibold">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded transition ${activeSubMenu === 'branding' ? 'bg-[#d11252] text-white font-extrabold shadow-sm' : 'text-slate-500 hover:text-slate-800'}`}
          >
            🎨 Branding & Layout Config (10 Core Setup)
          </button>
          <button
            onClick={() => setActiveSubMenu('compliance')}
            className={`px-3 py-1.5 rounded transition ${activeSubMenu === 'compliance' ? 'bg-[#492583] text-white font-extrabold shadow-sm' : 'text-slate-500 hover:text-slate-850'}`}
          >
            🏢 Compliance & Footer
          </button>
          <button
          ...
          <div className="border-t border-slate-100 pt-4 space-y-4">
            ...
            <div className="bg-rose-50/40 p-3 rounded-xl border border-rose-100/60 text-left space-y-2">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                <button
                  ...
                  onClick={() => {
                    setAppearanceForm({
                      ...appearanceForm,
                      primaryColor: '#d11252',
                      secondaryColor: '#492583'
                    });
                    alert('Official "Koseli Xpress" branding colors (Magenta Ribbon & Deep Purple Box) filled! Please click "Save Store Configuration" to apply website layout variations.');
                  }}
                ...
                >
                  <span className="inline-block w-2.5 h-2.5 rounded-full bg-[#d11252] border border-white/20"></span>
                  <span className="inline-block w-2.5 h-2.5 rounded-full bg-[#492583] border border-white/20"></span>
                  <span>💝 Koseli Xpress Official</span>
                </button>
                <button
                  type="button"
                  onClick={() => {
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-5 space-y-4 mt-6">
            <div className="flex justify-between items-center">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-bold text-purple-600 border border-purple-200 rounded hover:bg-purple-50 transition cursor-pointer"
              >
                      ...
                      return (
                        <tr key={grp.id} className="hover:bg-slate-50/50 bg-white">
                          ...
                          <td className="p-3 text-right font-mono text-xs">
                            <span className="bg-purple-100 text-purple-700 px-2 py-0.5 rounded-sm font-bold">{assignedProductsCount} items</span>
                          </td>
                          <td className="p-3 text-right space-x-1">
                            <button
                              onClick={() => handleEditGroup(grp)}
                              className="text-purple-600 hover:bg-purple-100 p-1 px-2 border border-purple-200 rounded text-[11px] font-bold transition cursor-pointer"
                            >
                              Edit
                            </button>
                            <button
      ...
      {activeSubMenu === 'gateways' && (
        <div className="space-y-6">
          <div className="bg-white border border-slate-100 rounded-xl p-5 space-y-4">
            ...
            <p className="text-xs text-slate-500 font-sans leading-normal">
              Toggle payment integrations and specify your sandbox keys, merchant hash secrets, and merchant codes. Checked gateways dynamically mount on checkout matching active currency configurations.
            </p>
              ...
              {paymentGateways.map((gw, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-4 pt-3 border-t border-dashed border-slate-200/50 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-left">
                      ...
                      <div>
                        ...
                        <div className="mt-1 border border-dashed border-slate-250 rounded p-1 bg-slate-50 hover:bg-slate-100 transition relative cursor-pointer text-center">
                          ...
                          />
                          <span className="text-[8.5px] font-bold text-[#492583] inline-flex items-center gap-0.5">
                            📷 Upload Gateway Logo
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="mt-2.5 flex justify-between items-center text-[10px] text-slate-400 font-sans">
                      <span>
            ...
            <div className="pt-2 flex justify-end">
              <button
                type="button"
                onClick={() => {
                  alert('All Integrated Payment Gateways successfully synced to cache databases.');
                }}
                className="px-5 py-2.5 bg-rose-600 hover:bg-rose-500 text-white font-black text-xs rounded-lg tracking-wider flex items-center gap-1.5 shadow-sm hover:shadow-md cursor-pointer transition uppercase"
              >
                <Save className="w-4 h-4" />
                <span>Save Gateways state</span>
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-5 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-rose-50 pb-4 gap-4 animate-in fade-in slide-in-from-top-2 duration-200">
              <div>
                <div className="flex items-center gap-1.5 font-sans font-bold text-slate-800 text-base">
                  <Sparkles className="w-5 h-5 text-[#d11252]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 font-sans text-xs">
              ...
              <div className="space-y-1.5">
                <label className="block text-[10px] font-bold text-[#492583] uppercase tracking-wider">1. Domain Registry Name</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5 text-left">
                <label className="block text-[10px] font-bold text-[#492583] uppercase tracking-wider">2. Primary Logo Image Path URL</label>
                <input
                  type="text"
                ...
                {/* Local Uploader */}
                <div className="border border-dashed border-slate-200 rounded-lg p-2 bg-slate-50 text-center hover:bg-slate-100/70 hover:border-[#492583]/30 transition relative cursor-pointer">
                  <input
                    type="file"
                    accept="image/*"
                    className="absolute inset-0 opacity-0 cursor-pointer w-full h-full"
              ...
              <div className="space-y-1.5 text-left">
                <label className="block text-[10px] font-bold text-[#492583] uppercase tracking-wider">3. Fav Image (Favicon Icon Path)</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="block text-[10px] font-bold text-[#492583] uppercase tracking-wider">4. Tagline / Slogan Brand Line</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5 md:col-span-2">
                <label className="block text-[10px] font-bold text-[#492583] uppercase tracking-wider">8. Global Shipping Guidelines & Notice</label>
              ...
              <div className="space-y-3.5 md:col-span-2 pt-2 border-t border-slate-100 text-left">
                <div>
                  <label className="block text-[10px] font-bold text-[#492583] uppercase tracking-wider">9. Terms and Conditions setup (Short & Full views)</label>
              ...
              <div className="space-y-4 md:col-span-2 pt-4 border-t border-slate-150 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5 md:col-span-2">
                    <span className="text-[9.5px] font-extrabold text-[#492583] uppercase block tracking-wide">📢 Compliance & Gifting SLA disclaimer (Publishes on All Products)</span>
                  ...
                  <div className="space-y-1.5 md:col-span-2">
                    <span className="text-[9.5px] font-extrabold text-[#492583] uppercase block tracking-wide">Footer Brand Description</span>
                  ...
                  <div className="space-y-1.5 md:col-span-2">
                    <span className="text-[9.5px] font-extrabold text-[#492583] uppercase block tracking-wide">Bespoke Craft Guarantee Description</span>
                    <textarea
      ...
      {groupModalOpen && editingGroup && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-[100] p-4 text-slate-800 overflow-y-auto">
          <div className="bg-white rounded-xl shadow-2xl border border-slate-200/85 w-full max-w-2xl p-6 space-y-4 animate-in fade-in zoom-in-95 duration-150 text-left my-8">
            <div className="flex items-center gap-2 pb-2 border-b border-purple-150 justify-between">
              <div className="flex items-center gap-2">
                <Sliders className="w-5 h-5 text-purple-600" />
                <h4 className="font-bold text-slate-900 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 border border-slate-200 rounded-lg font-bold focus:ring-purple-500 focus:border-purple-500 bg-slate-50 text-slate-800 placeholder-slate-400 text-xs"
                ...
                <div>
                  ...
                  <input
                    type="number"
                    placeholder="e.g. 180"
                    className="w-full p-2.5 border border-slate-200 rounded-lg font-mono font-bold focus:ring-purple-500 focus:border-purple-500 bg-slate-50 text-slate-800 placeholder-slate-400 text-xs"
              ...
              <div className="flex flex-col space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <div className="space-x-2 text-[10px] font-bold text-purple-600">
                    <button
                      type="button"
                    ...
                    return (
                      <label key={`modal-dist-${dist.id}`} className="flex items-center gap-2.5 font-sans font-semibold text-slate-705 cursor-pointer py-0.5">
                        <input
                          ...
                          className="w-4 h-4 text-purple-600 border-slate-300 focus:ring-purple-500 rounded cursor-pointer"
                        />
                        <span>{dist.name}</span>
                      </label>
                    );
                ...
                {(state.products || []).map((prod) => {
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-center gap-2 p-1.5 border rounded-lg cursor-pointer bg-white transition hover:border-purple-300 ${isChecked ? 'border-purple-400 ring-1 ring-purple-100' : 'border-slate-200'}`}
                    >
                      <input
                        type="checkbox"
                        checked={isChecked}
                        ...
                        className="w-3.5 h-3.5 text-purple-600 border-slate-300 focus:ring-purple-500 rounded cursor-pointer"
                      />
            ...
            <div className="flex justify-end gap-2.5 pt-4 text-xs border-t border-slate-150">
              ...
              <button
                ...
                className="px-5 py-2 font-bold text-white bg-purple-600 hover:bg-purple-700 rounded-lg shadow-md transition cursor-pointer"
              >
                Save Delivery Group
              </button>
            </div>
        ...
        <div className="space-y-6 text-left animate-in fade-in duration-200">
          <div className="bg-white border border-slate-100 rounded-xl p-5 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-rose-50 pb-4 gap-4">
              <div>
                <div className="flex items-center gap-1.5 font-sans font-bold text-slate-800 text-base">
                  <Building className="w-5 h-5 text-[#492583]" />
              ...
              <button
                ...
                className="px-5 py-2 font-bold text-xs text-white bg-[#492583] hover:bg-[#341a5e] rounded-lg shadow-sm transition inline-flex items-center gap-1.5"
              >
            ...
            <div className="pt-4 border-t border-slate-100 flex justify-end">
              <button
                ...
                className="px-6 py-2.5 font-bold text-sm text-white bg-[#492583] hover:bg-[#341a5e] rounded-xl shadow-md transition inline-flex items-center gap-2"
              >
